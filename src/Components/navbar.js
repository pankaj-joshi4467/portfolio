      ...
      <AppBar component="nav" style={{background: "transparent"}} elevation={0}>
        <Toolbar style={{margin: "20px 0", boxShadow: "0 0px"}}>
          ...
          <Box sx={{display: { xs: 'none', sm: 'block' }}}>
            <a className='resume-button' href={"https://drive.google.com/file/d/1Knhus4NtLYuUqQ3D-jxvvUPZyr1v4eT2/view?usp=sharing"}><span class="text">Resume</span><span>Resume</span></a>
          </Box>
        </Toolbar>
      </AppBar>
      <nav>
